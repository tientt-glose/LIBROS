...
$config['backends'][] = array(
    'name'         => 'my_ftp',
    'adapter'      => 'ftp',
	'host'		   => 'srv162.main-hosting.eu',
	'username'     => 'u287515793',
    'password'     => 'XQ0wR6fMDeSx',
	'port' =>'21',
    'baseUrl'      => '/libros.network/public_html/upload/sach',
	//'root'         => '/domains/libros.network/public_html/upload/sach', // Can be used to explicitly set the CKFinder user files directory.
