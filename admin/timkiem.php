    ...
    <div class="container">
       <label for="search"><b>TÌM KIẾM</b></label>
        <input type="text" placeholder="Nhập từ khóa" name="search" required>
         ...
         <p><?php
			 if (isset($_GET["search"])) $tukhoa = $_GET["search"];
    else $tukhoa ="";
			 $t= DanhSachBook_search($tukhoa);
			 $tongsosach=mysqli_num_rows($t);
			 if ($tukhoa!="") echo "Kết quả tìm kiếm: $tongsosach sách";
			 ?></p>
    </div>
</form>
            </td>
          ...
          <tr>
            ...
            <td rowspan="2" style="text-align: center"><a href="suaSach.php?id={IDSach}">{Tensach}</a><br>
      ...
      <div id="phantrang"><?php 
		  ...
		  {
			?>  
			<a <?php if ($i==$trang) echo "style='background-color: red'"?>href="timkiem.php?trang=<?php echo $i?>&search=<?php echo $tukhoa?>"> <?php echo $i?></a>
		  <?php }
		  ?></div></td>
    </tr>
        </tbody>
